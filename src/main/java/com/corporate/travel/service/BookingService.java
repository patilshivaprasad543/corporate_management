...
public class BookingService {
    ...
    public BookingDto.Response createBooking(Long userId, BookingDto.CreateBookingRequest dto) {
        ...
        Booking booking = Booking.builder()
                ...
                .personalBooking(dto.getPersonalBooking() != null ? dto.getPersonalBooking() : false)
        ...
        notificationService.sendNotification(user.getId(), "Booking Confirmed - " + pnr,
                "Your travel booking " + ref + " (PNR: " + pnr + ") is confirmed. E-ticket issued.",
                NotificationType.BOOKING_CONFIRMED, "/itinerary");
    ...
    private void buildItineraryForBooking(User user, TravelRequest request, Booking booking) {
        ...
        events.add(ItineraryEvent.builder()
                .itinerary(itinerary)
                .eventTime(dep)
                .title("Flight AI-839 (Hyderabad -> Delhi)")
                .location("Rajiv Gandhi Intl Airport Terminal 1")
                .eventType("FLIGHT")
                .notes("Check-in 2 hours prior. PNR: " + booking.getPnrNumber())
                .confirmationCode(booking.getPnrNumber())
                .build());

        events.add(ItineraryEvent.builder()
                .itinerary(itinerary)
                .eventTime(dep.plusHours(3))
                .title("Airport Executive Transfer to Hotel")
                .location("Delhi Airport Terminal 3 Uber Zone")
                .eventType("TRANSFER")
                .notes("Uber Premium sedan reserved")
                .confirmationCode("UBER-TRIP-749")
                .build());

        events.add(ItineraryEvent.builder()
                .itinerary(itinerary)
                .eventTime(dep.plusHours(4).plusMinutes(30))
                .title("Hotel Check-in: Taj Palace")
                .location("Diplomatic Enclave, Chanakyapuri")
                .eventType("HOTEL_CHECKIN")
                .notes("Early check-in requested. Corporate loyalty badge applied.")
                .confirmationCode("HTL-TAJ-992")
                .build());

        events.add(ItineraryEvent.builder()
                .itinerary(itinerary)
                .eventTime(dep.plusHours(7))
                .title("Client Business Review & Strategy Session")
                .location("Cyber City Tower B, 14th Floor")
                .eventType("MEETING")
                .notes("Present Q3 corporate tech roadmap")
                .build());
    ...
    public BookingDto.Response mapToResponse(Booking b) {
        List<BookingDto.BookingItemDto> itemDtos = b.getItems() != null ?
                b.getItems().stream().map(i -> BookingDto.BookingItemDto.builder()
                        .id(i.getId())
                        .itemType(i.getItemType())
                        .title(i.getTitle())
                        .description(i.getDescription())
                        .supplierReference(i.getSupplierReference())
                        .price(i.getPrice())
        ...
        return BookingDto.Response.builder()
                ...
                .status(b.getStatus())
                .travelRequestId(b.getTravelRequest() != null ? b.getTravelRequest().getId() : null)
                .tripName(b.getTravelRequest() != null ? b.getTravelRequest().getTripName() : "Direct Booking")
                .totalAmount(b.getTotalAmount())
                .taxAmount(b.getTaxAmount())
                .currencyCode(b.getCurrencyCode())
                .paymentMethod(b.getPaymentMethod())
                .personalBooking(b.getPersonalBooking())
                .eTicketNumber(b.getETicketNumber())
